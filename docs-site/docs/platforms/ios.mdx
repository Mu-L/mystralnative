...
Platform-specific information for running MystralNative on iOS.

## Overview

iOS support allows you to embed MystralNative in native iOS applications. Games run via Metal with the wgpu-native backend.
