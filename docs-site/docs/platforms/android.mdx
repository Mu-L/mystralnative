...
Platform-specific information for running MystralNative on Android.

## Overview

Android support allows you to embed MystralNative in native Android applications. Games run via Vulkan with the wgpu-native backend.
...
- [Embedding](/docs/api/embedding) - C++ embedding API
