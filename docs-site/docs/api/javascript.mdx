...
MystralNative implements standard Web APIs for graphics, audio, networking, and input.

## Supported APIs

| API | Status | Notes |
|-----|--------|-------|
| WebGPU | Full | Core graphics API |
| Canvas 2D | Full | Skia-based implementation |
| Web Audio | Full | SDL3-based audio |
| fetch | Full | HTTP/HTTPS and file:// |
...
- [Embedding](/docs/api/embedding) - Use as a C++ library
