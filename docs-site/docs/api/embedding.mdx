...
Use MystralNative as a C++ library in your own applications.

## Overview

MystralNative can be embedded in native applications to run JavaScript games within your own windowing and rendering context. This is useful for:
...
For iOS apps, use MystralNative with a Metal-backed view:
...
For Android apps, use MystralNative with a SurfaceView:
...
Add MystralNative to your CMake project:
...
- [Building from Source](/docs/guides/building) - Build the library
- [Platform Guides](/docs/platforms/macos) - Platform-specific details
