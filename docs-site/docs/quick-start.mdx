...
Let's run your first WebGPU game with MystralNative.

## Running Examples

After [installing](/docs/installation) MystralNative, try the included examples:
...
MystralNative supports loading assets via `fetch`:
...
- [Running Games](/docs/guides/running-games) - CLI options and window configuration
- [CLI Commands](/docs/api/cli) - Full command reference
